...
async function run() {
  await vectorizeFile('test_1_baseline.png', 'vector_1_baseline.svg');
  await vectorizeFile('test_2_upscale4x.png', 'vector_2_upscale4x.svg');
  await vectorizeFile('test_4_threshold180.png', 'vector_4_threshold180.svg');
  await vectorizeFile('test_6_sharpen_threshold180.png', 'vector_6_sharpen_threshold180.svg');
