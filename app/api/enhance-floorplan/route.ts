...
const ENHANCE_PROMPT = `A professionally enhanced 2D architectural CAD floor plan. Clean, crisp, high-contrast black lines on a pure white background. Refine and straighten all walls, door arc symbols, and window lines. Maintain the exact same room positions, layout structure, furniture placements, and text labels unchanged. Make it look like a clean, master-level engineering blueprint.`;
